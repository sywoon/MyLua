...
:MAKE_SOCKET
mkdir ..\\output\\socket
cl /EHsc /O2 /W3 /c /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_USRDLL"  /D "LUASOCKET_API=__declspec(dllexport)" /D "_CRT_SECURE_NO_WARNINGS" /D "_USING_V110_SDK71_" /I"../lib/include/" auxiliar.c buffer.c except.c inet.c io.c luasocket.c options.c select.c tcp.c timeout.c udp.c wsocket.c
